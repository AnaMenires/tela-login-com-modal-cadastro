    ...
    <div className="min-h-screen flex flex-col bg-gray-100">
      ...
      <main className="flex-1 container mx-auto px-6 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 -mt-24">
            <CardTransaction title="Entradas" background="bg-white" icon= { <ArrowCircleUp className="text-green-500" size={32} />} />
            <CardTransaction title="Saidas" background="bg-white" icon= {<ArrowCircleDown className="text-red-500" size={32} />} />
            <CardTransaction title="Total" background="bg-emerald-500" textColor="text-white" icon= {<CurrencyCircleDollar size={32} />} />
         </div>
